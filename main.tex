...
\input{Dateien/custom_commands}


\begin{document}
\input{Dateien/title_page}
...
\include{0Wiederholung}
\include{1Fourier_Reihen}
\include{2Lebesgue_Integrierbarkeit}
\include{3Tensorprodukte}
\include{4Hoehere_Analysis}
